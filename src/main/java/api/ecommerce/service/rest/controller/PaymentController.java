...
//    public ResponseEntity<PaymentDto> createPayment(@RequestBody RequestPayment requestPayment,@PathVariable Long idClient){
//        PaymentDto paymentDto = paymentService.createPayment(requestPayment,idClient);
...
//        return ResponseEntity.status(HttpStatus.OK).body(paymentDto);
//    }
//    @PutMapping(value = "/client/{idClient}")
//    public ResponseEntity<PaymentDto> updatePayment(@RequestBody RequestPayment requestPayment,@PathVariable Long idClient){
//        PaymentDto paymentDto = paymentService.createPayment(requestPayment,idClient);
//        return ResponseEntity.status(HttpStatus.OK).body(paymentDto);
//    }
